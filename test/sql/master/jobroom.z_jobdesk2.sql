...
/* Formatted on 23.07.2018 12:07:42 (QP5 v5.215.12089.38647) */
...
(
  ...
  AS
    SELECT a.ID,
      ...
      a.SK5_AUFENTHALT_B,
      ISCO.ISCO_08_CODE,
      CASE WHEN a.STELLENNUMMER_AVAM IS NULL
        THEN 'X28'
      ELSE 'RAV' END
                 AS SOURCE,
      CASE
      WHEN a.PENSUM_VON = 100 AND a.PENSUM_BIS = 100
        THEN 1
      ELSE 0
      END
                 AS FULLTIME,
